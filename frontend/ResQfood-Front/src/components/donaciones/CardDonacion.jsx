  ...
  return (
    <article
      className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden
                 flex flex-col xl:flex-row w-full max-w-7xl mx-auto"
    >
      {/* Imagen */}
      <div className="w-full aspect-[4/3] xl:w-64 xl:h-64 xl:aspect-auto shrink-0 overflow-hidden bg-gray-50">
      ...
      <div className="p-4 flex-1 flex flex-col gap-2 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <h3 className="font-semibold text-lg text-gray-900 truncate">{titulo}</h3>
        ...
        {descripcion && <p className="text-base text-gray-700 line-clamp-3">{descripcion}</p>}
        {(dir || ciudadProv) && (
